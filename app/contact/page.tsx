                ...
                <Block className={`col-span-3 bg-lime`}>
                    ...
                    >
                        <div className="text-center relative z-10 text-shadow-lg">
                            ...
                            <p className="text-xl font-bold">
                                Siamo una realtà autofinanziata! Supportaci donando il 5x1000 a COMITATO BRESCIA PRIDE -
                                Codice Fiscale 98201800178 o con una <Link className={`underline`}
                                                                           href="https://www.paypal.com/paypalme/bresciapride">donazione</Link>!
                            </p>
                        </div>
                    </div>
                </Block>
