  ...
  return (
    <Block className={`col-span-${size} flex items-center justify-between p-6 bg-red text-pink`}>
      ...
      <div className="relative" ref={menuRef}>
        ...
        {menuOpen && (
          <div className="absolute right-0 mt-2 w-60 bg-white border rounded shadow-lg z-50 text-red text-2xl">
            <ul className="flex flex-col">
              <li>
                <Link href="/manifesto.pdf" className="block px-4 py-2 hover:bg-gray-100" onClick={() => setMenuOpen(false)}>
                  Manifesto (2024)
                </Link>
              </li>
              <li>
                <Link href="/events" className="block px-4 py-2 hover:bg-gray-100" onClick={() => setMenuOpen(false)}>
                  Eventi
                </Link>
              </li>
              <li>
                <Link href="/resources" className="block px-4 py-2 hover:bg-gray-100" onClick={() => setMenuOpen(false)}>
                  Risorse
                </Link>
              </li>
              <li>
                <Link href="/contact" className="block px-4 py-2 hover:bg-gray-100" onClick={() => setMenuOpen(false)}>
                  Contatti
                </Link>
              </li>
            </ul>
