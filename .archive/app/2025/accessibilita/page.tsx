...
export default function AccessibilitaPage() {
  return (
    <Block>
      <div className="">Questa pagina è del 2025, la pagina più aggiornata è qui: <Link href="/2026/accessibilita"></Link></div>
    </Block>
    ...
    //         aria-labelledby="vademecum-title"
    //       >
    //         <h3 className="text-lg sm:text-xl font-bold text-center">
    //           Nel vademecum troverete informazioni su:
    //         </h3>
    //         <ul
    //           className="text-base sm:text-lg md:text-xl mt-2 leading-relaxed max-w-4xl mx-auto list-disc list-inside space-y-1"
    //           role="list"
    //         >
    ...
    //           Tutti gli interventi e le performance prima e dopo il corteo sono
    //           trascritte qui!
    //         </p>
    //         <div className="mt-4 text-center grid grid-cols-1 gap-4 max-w-4xl mx-auto">
    //           <Button
    ...
    //               const link = document.createElement("a");
    //               link.href =
    //                 "https://docs.google.com/document/d/1626Y9Fcf5vX00BVeMsTSWmnPC5y9EGJ2faoVXgvZKH4/edit?usp=sharing";
    //               link.target = "_blank";
    //               link.rel = "noopener noreferrer";
    //               document.body.appendChild(link);
    //               link.click();
