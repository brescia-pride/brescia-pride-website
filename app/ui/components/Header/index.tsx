...
const Header = ({ size }: BlockProps) => {
  ...
  return (
    ...
    >
      ...
      <Link href="/">
        <h1
          className={`text-2xl md:text-4xl leading-tight font-medium mr-2 flex-1 text-center transition-transform transition-colors duration-300 hover:scale-110 hover:text-pink-800 ${myFont.className}`}
        >
          Brescia Pride
        </h1>
      </Link>
