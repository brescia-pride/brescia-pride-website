        ...
        <Block className={`col-span-2 bg-blue`}>
          <Link href={"/giugno-brescia-pride.pdf"}>
            ...
            >
              ...
              <div className={`absolute inset-0 text-6xl pointer-events-none transition-opacity duration-300 ${isRevealed ? 'opacity-30' : 'opacity-20'}`}>
          ...
          >
            <div className="text-center relative z-10 text-shadow-lg">
              ...
              <p className="text-md md:text-lg font-semibold">
                Scorri in basso per la locandina e scrivici un DM su Instagram o una mail per partecipare 🫶
              </p>
            </div>
          </div>
        </Block>
